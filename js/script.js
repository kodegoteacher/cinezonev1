...
const global = {
  ...
  api: {
    apiKey: "2c7b41aeee968eb46df10ecb0df3793c",
...
async function displayShowDetails() {
  ...
  <div class="details-top">
  <div>
  ${show.poster_path ? `<img src="https://image.tmdb.org/t/p/w500${show.poster_path}" class="card-img-top" alt="${show.title}"/>` 
  : `      <img
  src="./images/no-image.jpg"
  class="card-img-top"
  alt="${show.name}"
...
document.querySelector('#pagination').innerHTML = '';
  ...
  results.forEach((result) => {
    ...
    ${result.poster_path ? `<img src="https://image.tmdb.org/t/p/w500${result.poster_path}" class="card-img-top" alt="${global.search.type === 'movie' ? result.title : result.name}"/>` 
    : `      <img
    src="./images/no-image.jpg"
    class="card-img-top"
...
async function searchAPIData() {  
  ...
  showSpinner();  const response = await fetch(    
